...
namespace Si.Utilites
{
    ...
    public static class KestrelConfig
    {
        ...
        /// <param name="configSectionPath">配置节路径，默认为"Kestrel" 配置示例
        /// "Kestrel": {"Url": "0.0.0.0","Http": {"Port": 5000},"Https": {"Enabled": true,"Port": 5001,"Certificate": {"Path": "certificate.pfx","Password": "yourpassword"}}}</param>
        ...
        public static WebApplicationBuilder UseKestrelServer(this WebApplicationBuilder builder, string configSectionPath = "Kestrel")
        {
            ...
            builder.WebHost.ConfigureKestrel(options =>
            {
                ...
                {
                    throw new Exception("Kestrel配置错误", ex);
                }
            });
