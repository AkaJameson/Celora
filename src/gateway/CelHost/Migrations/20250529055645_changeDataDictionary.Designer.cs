...
namespace CelHost.Migrations
{
    ...
    [Migration("20250529055645_changeDataDictionary")]
    partial class changeDataDictionary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CelHost.Server.Data.BlocklistRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CelHost.Server.Data.Cascade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CelHost.Server.Data.Cluster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CelHost.Server.Data.ClusterNode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CelHost.Server.Data.HealthCheckOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CelHost.Server.Data.RateLimitPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CelHost.Server.Data.SystemDict", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("typeCode", "typeName")
                        .IsUnique();

                    b.ToTable("SystemDict");
                });

            modelBuilder.Entity("CelHost.Server.Data.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CelHost.Server.Data.Cluster", b =>
                {
                    b.HasOne("CelHost.Server.Data.HealthCheckOption", "CheckOption")
                        .WithMany()
                        .HasForeignKey("CheckOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CelHost.Server.Data.HealthCheckOption", null)
                        .WithMany("Clusters")
            ...
            modelBuilder.Entity("CelHost.Server.Data.ClusterNode", b =>
                {
                    b.HasOne("CelHost.Server.Data.Cluster", "Cluster")
                        .WithMany("Nodes")
