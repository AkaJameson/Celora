...
namespace CelHost.Server.Proxy
{
    public class DestinationHealthCheck
    {
        ...
        public DestinationHealthCheck(IProxyStateLookup proxyStateLookup, IHubContext<HealthHub> hubContext)
        {
        ...
        public async Task CheckAndBroadcastChangesAsync()
        {
            ...
            await _hubContext.Clients.All.SendAsync("HealthUpdate", DestinationHealthStates);
        }
    }
}
